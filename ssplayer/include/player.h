...
typedef struct {
    ...
    int (*audio_deinit)(void *arg);
    int (*audio_pause)(void);
    int (*audio_resume)(void);
    int (*audio_mute)(void);
    int (*audio_play)(void *arg, char *data, int len);
    int (*video_init)(void *arg);
    int (*video_deinit)(void *arg);
    int (*video_play)(void *arg, void *frame);
...
typedef struct {
    ...
    int decoder_type, status;
    bool demux_status, audio_enable, video_enable;
    player_opts_t options;
