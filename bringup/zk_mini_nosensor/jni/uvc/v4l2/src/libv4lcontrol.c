...
static const struct v4l2_queryctrl fake_controls[V4LCONTROL_COUNT] = {
{
  ...
  .name = {'W', 'h', 'i', 't', 'e', 'b', 'a', 'l', 'a', 'n', 'c', 'e', ' ', '(', 's', 'o', 'f', 't', 'w', 'a', 'r', 'e', ')', '\0'},
  .minimum = 0,
  .maximum = 1,
  .step = 1,
  .default_value = 0,
...
},
{
  ...
  .name = {'H', 'o', 'r', 'i', 'z', 'o', 'n', 't', 'a', 'l', ' ', 'f', 'l', 'i', 'p', ' ', '(', 's', 'w', ')', '\0'},
  .minimum = 0,
  .maximum = 1,
  .step = 1,
  .default_value = 0,
...
},
{
  ...
  .name = {'V', 'e', 'r', 't', 'i', 'c', 'a', 'l', ' ', 'f', 'l', 'i', 'p', ' ', '(', 's', 'w', ')', '\0'},
  .minimum = 0,
  .maximum = 1,
  .step = 1,
  .default_value = 0,
...
},
{
  ...
  //.name =  "Gamma (software)",
  .name = {'G', 'a', 'm', 'm', 'a', ' ', '(', 's', 'o', 'f', 't', 'w', 'a', 'r', 'e', ')', '\0'},
  .minimum = 500,  /* == 0.5 */
  .maximum = 3000, /* == 3.0 */
  .step = 1,
...
{}, /* Dummy place holder for V4LCONTROL_AUTO_ENABLE_COUNT */
{
  ...
  .name = {'A', 'u', 't', 'o', ' ', 'G', 'a', 'i', 'n', ' ', '(', 's', 'o', 'f', 't', 'w', 'a', 'r', 'e', ')', '\0'},
  .minimum = 0,
  .maximum = 1,
  .step = 1,
  .default_value = 1,
...
},
{
  ...
  .name = {'A', 'u', 't', 'o', ' ', 'G', 'a', 'i', 'n', ' ', 't', 'a', 'r', 'g', 'e', 't', '\0'},
  .minimum = 0,
  .maximum = 255,
  .step = 1,
  .default_value = 100,
...
struct v4lcontrol_data *v4lcontrol_create(int fd, int always_needs_conversion)
{
  ...
  struct v4lcontrol_data *data = (struct v4lcontrol_data *)calloc(1, sizeof(struct v4lcontrol_data));
  ...
  if (shm_fd >= 0) {
    ...
    data->shm_values = (unsigned int*)mmap(NULL, V4LCONTROL_SHM_SIZE, (PROT_READ | PROT_WRITE),
			    MAP_SHARED, shm_fd, 0);
    close(shm_fd);
  ...
  if (data->shm_values == NULL) {
    ...
    data->shm_values = (unsigned int*)malloc(V4LCONTROL_SHM_SIZE);
    if (!data->shm_values) {
      fprintf(stderr, "libv4lcontrol: error: out of memory!\n");
      goto error;
    }
