...
static testButtonActivity* mActivityPtr;
...
void testButtonActivity::registerUserTimer(int id, int time) {
	registerTimer(id, time);
}

void testButtonActivity::unregisterUserTimer(int id) {
	unregisterTimer(id);
}

void testButtonActivity::resetUserTimer(int id, int time) {
	resetTimer(id, time);
}