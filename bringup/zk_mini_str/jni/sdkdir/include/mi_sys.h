...
MI_S32 MI_SYS_ChnInputPortGetBufPa (MI_SYS_ChnPort_t *pstChnPort,MI_SYS_BufConf_t *pstBufConf, MI_SYS_BufInfo_t *pstBufInfo, MI_SYS_BUF_HANDLE *pBufHandle, MI_S32 s32TimeOutMs);

MI_S32 MI_SYS_ChnInputPortPutBufPa (MI_SYS_BUF_HANDLE bufHandle,  MI_SYS_BufInfo_t *pstBufInfo, MI_BOOL bDropBuf);

MI_S32 MI_SYS_ChnOutputPortGetBufPa (MI_SYS_ChnPort_t *pstChnPort,MI_SYS_BufInfo_t *pstBufInfo,MI_SYS_BUF_HANDLE *pBufHandle);
