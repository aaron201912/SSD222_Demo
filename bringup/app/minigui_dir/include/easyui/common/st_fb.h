...
MI_S32 ST_FB_FlushBuffer(MI_PHY DrawPhyAddr, MI_U16 u16SrcBufW, MI_U16 u16SrcBufH, MI_GFX_Rect_t stRect, MI_S32 s32ColorFmt);
void ST_FB_ChangeOffset(MI_S32 s32Yoffset);
